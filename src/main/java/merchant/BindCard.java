...
public class BindCard implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":bindCard", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "bindCard", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static BindCard parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            BindCard object = new BindCard();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"bindCard".equals(type)) {
                            ...
                            return (BindCard) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
