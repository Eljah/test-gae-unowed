...
/**
 *  SamsungPayPaymentRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SamsungPayPaymentRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = samsungPayPaymentRequest
     ...
     */
    protected merchant.AdditionalParameters_type7 localAdditionalParameters;
    ...
    /**
     * Auto generated getter method
     * @return merchant.AdditionalParameters_type7
     */
    public merchant.AdditionalParameters_type7 getAdditionalParameters() {
    ...
    public void setAdditionalParameters(
        merchant.AdditionalParameters_type7 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":samsungPayPaymentRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "samsungPayPaymentRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SamsungPayPaymentRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SamsungPayPaymentRequest object = new SamsungPayPaymentRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"samsungPayPaymentRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SamsungPayPaymentRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "additionalParameters").equals(
                            reader.getName())) {
                    object.setAdditionalParameters(merchant.AdditionalParameters_type7.Factory.parse(
                            reader));
