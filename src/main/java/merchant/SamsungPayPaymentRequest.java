...
public class SamsungPayPaymentRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected AdditionalParameters_type7 localAdditionalParameters;
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.AdditionalParameters_type7
     */
    public AdditionalParameters_type7 getAdditionalParameters() {
    ...
    public void setAdditionalParameters(
        AdditionalParameters_type7 param) {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"samsungPayPaymentRequest".equals(type)) {
                            ...
                            return (SamsungPayPaymentRequest) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "additionalParameters").equals(
                            reader.getName())) {
                    object.setAdditionalParameters(AdditionalParameters_type7.Factory.parse(
                            reader));
