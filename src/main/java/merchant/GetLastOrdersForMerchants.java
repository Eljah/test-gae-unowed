...
public class GetLastOrdersForMerchants implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Request
     */
    protected merchant.GetLastOrdersForMerchantsRequest localRequest;

    /**
     * Auto generated getter method
     * @return merchant.GetLastOrdersForMerchantsRequest
     */
    public merchant.GetLastOrdersForMerchantsRequest getRequest() {
        return localRequest;
    }
    ...
    public void setRequest(
        merchant.GetLastOrdersForMerchantsRequest param) {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getLastOrdersForMerchants".equals(type)) {
                            ...
                            return (GetLastOrdersForMerchants) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        object.setRequest(merchant.GetLastOrdersForMerchantsRequest.Factory.parse(
                                reader));
