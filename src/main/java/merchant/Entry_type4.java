...
/**
 *  Entry_type4 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Entry_type4 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":entry_type4", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "entry_type4", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Entry_type4 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Entry_type4 object = new Entry_type4();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"entry_type4".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Entry_type4) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
