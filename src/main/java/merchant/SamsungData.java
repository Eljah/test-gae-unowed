...
/**
 *  SamsungData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SamsungData implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":samsungData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "samsungData", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SamsungData parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            SamsungData object = new SamsungData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"samsungData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SamsungData) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
