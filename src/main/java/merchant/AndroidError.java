...
/**
 *  AndroidError bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AndroidError implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":androidError", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "androidError", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AndroidError parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AndroidError object = new AndroidError();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"androidError".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AndroidError) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
