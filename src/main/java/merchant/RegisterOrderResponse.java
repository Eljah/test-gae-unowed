...
public class RegisterOrderResponse extends AbstractResponse
     ...
     * @param param FormUrl
     */
    public void setFormUrl(String param) {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"registerOrderResponse".equals(type)) {
                            ...
                            return (RegisterOrderResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
