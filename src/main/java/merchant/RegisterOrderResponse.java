...
/**
 *  RegisterOrderResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterOrderResponse extends merchant.AbstractResponse
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = registerOrderResponse
     ...
     * field for FormUrl
     */
    protected java.lang.String localFormUrl;
     ...
     * @param param FormUrl
     */
    public void setFormUrl(java.lang.String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":registerOrderResponse", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "registerOrderResponse", xmlWriter);
        }
        ...
        if (localFormUrlTracker) {
            ...
            if (localFormUrl == null) {
                ...
                xmlWriter.writeCharacters(localFormUrl);
            }
    ...
    public static class Factory {
         ...
         */
        public static RegisterOrderResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterOrderResponse object = new RegisterOrderResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"registerOrderResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterOrderResponse) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "formUrl").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "formUrl" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setFormUrl(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
