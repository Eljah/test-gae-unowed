...
/**
 *  AddParamsRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddParamsRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = addParamsRequest
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":addParamsRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "addParamsRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AddParamsRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AddParamsRequest object = new AddParamsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addParamsRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddParamsRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
