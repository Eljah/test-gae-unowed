...
/**
 *  LoginParams bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LoginParams extends AbstractServiceRequest
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":loginParams", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "loginParams", xmlWriter);
        }
        ...
        if (localLogin != null) {
            writeAttribute("", "login",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localLogin), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static LoginParams parse(javax.xml.stream.XMLStreamReader reader)
            throws Exception {
            LoginParams object = new LoginParams();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"loginParams".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LoginParams) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                // handle attribute "login"
                String tempAttribLogin = reader.getAttributeValue(null,
                        "login");

                if (tempAttribLogin != null) {
                    String content = tempAttribLogin;
                ...
                handledAttributes.add("login");

                // handle attribute "password"
                String tempAttribPassword = reader.getAttributeValue(null,
                        "password");

                if (tempAttribPassword != null) {
                    String content = tempAttribPassword;
