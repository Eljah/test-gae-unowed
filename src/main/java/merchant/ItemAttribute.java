...
/**
 *  ItemAttribute bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ItemAttribute implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":itemAttribute", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "itemAttribute", xmlWriter);
            }
        }
    ...
    public static class Factory {
        ...
        public static ItemAttribute fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return ItemAttribute.Factory.fromString(content, "");
            }
        }
