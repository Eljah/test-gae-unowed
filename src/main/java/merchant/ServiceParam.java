...
/**
 *  ServiceParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ServiceParam implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":serviceParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "serviceParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ServiceParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ServiceParam object = new ServiceParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"serviceParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ServiceParam) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                String tempAttribValue = reader.getAttributeValue(null,
                        "value");

                if (tempAttribValue != null) {
                    String content = tempAttribValue;
