...
/**
 *  AndroidData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AndroidData implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":androidData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "androidData", xmlWriter);
            }
        }
