...
/**
 *  GetBindingsRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetBindingsRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getBindingsRequest
     ...
     * This was an Attribute!
     */
    protected boolean localShowExpired;
    ...
    public boolean getShowExpired() {
        return localShowExpired;
    }

    /**
     * Auto generated setter method
     * @param param ShowExpired
     */
    public void setShowExpired(boolean param) {
        this.localShowExpired = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getBindingsRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getBindingsRequest", xmlWriter);
            }
        }
        ...
        if (true) {
            writeAttribute("", "showExpired",
                org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localShowExpired), xmlWriter);
        }
        else {
            throw new org.apache.axis2.databinding.ADBException(
                "required attribute localShowExpired is null");
        }
    ...
    public static class Factory {
         ...
         */
        public static GetBindingsRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetBindingsRequest object = new GetBindingsRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getBindingsRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetBindingsRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (tempAttribShowExpired != null) {
                    ...
                    throw new org.apache.axis2.databinding.ADBException(
                        "Required attribute showExpired is missing");
                }
