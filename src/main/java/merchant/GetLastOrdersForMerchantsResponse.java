/**
 * GetLastOrdersForMerchantsResponse.java
 *
...
/**
 *  GetLastOrdersForMerchantsResponse bean class
 */
...
public class GetLastOrdersForMerchantsResponse extends merchant.AbstractResponse
     ...
     */
    protected boolean localOrderStatusesTracker = false;
    ...
    public boolean isOrderStatusesSpecified() {
        return localOrderStatusesTracker;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":getLastOrdersForMerchantsResponse",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
        ...
        if (localOrderStatusesTracker) {
            if (localOrderStatuses != null) {
                for (int i = 0; i < localOrderStatuses.length; i++) {
                    if (localOrderStatuses[i] != null) {
                        localOrderStatuses[i].serialize(new javax.xml.namespace.QName(
                                "", "orderStatuses"), xmlWriter);
                    } else {
                        writeStartElement(null, "", "orderStatuses", xmlWriter);
    ...
    public static class Factory {
        ...
        public static GetLastOrdersForMerchantsResponse parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "orderStatuses").equals(
                            reader.getName())) {
                    // Process the array and step past its final element's end.
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
