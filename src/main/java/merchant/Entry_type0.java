...
/**
 *  Entry_type0 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Entry_type0 implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static Entry_type0 parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"entry_type0".equals(type)) {
                            ...
                            return (Entry_type0) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
