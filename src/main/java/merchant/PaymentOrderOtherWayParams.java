/**
 * PaymentOrderOtherWayParams.java
 *
...
/**
 *  PaymentOrderOtherWayParams bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PaymentOrderOtherWayParams extends merchant.AbstractServiceRequest
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = paymentOrderOtherWayParams
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":paymentOrderOtherWayParams",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "paymentOrderOtherWayParams", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static PaymentOrderOtherWayParams parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PaymentOrderOtherWayParams object = new PaymentOrderOtherWayParams();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"paymentOrderOtherWayParams".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PaymentOrderOtherWayParams) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
