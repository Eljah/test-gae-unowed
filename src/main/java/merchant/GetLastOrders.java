...
/**
 *  GetLastOrders bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetLastOrders implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getLastOrders", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getLastOrders", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetLastOrders parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetLastOrders object = new GetLastOrders();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getLastOrders".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetLastOrders) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
