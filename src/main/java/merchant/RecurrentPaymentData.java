...
/**
 *  RecurrentPaymentData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RecurrentPaymentData implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = recurrentPaymentData
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":recurrentPaymentData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "recurrentPaymentData", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RecurrentPaymentData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RecurrentPaymentData object = new RecurrentPaymentData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"recurrentPaymentData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RecurrentPaymentData) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
