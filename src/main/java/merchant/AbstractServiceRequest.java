...
/**
 *  AbstractServiceRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public abstract class AbstractServiceRequest implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = abstractServiceRequest
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":abstractServiceRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "abstractServiceRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AbstractServiceRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AbstractServiceRequest object = null;
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"abstractServiceRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AbstractServiceRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
