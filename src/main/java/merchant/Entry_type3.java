...
/**
 *  Entry_type3 bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Entry_type3 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":entry_type3", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "entry_type3", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Entry_type3 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Entry_type3 object = new Entry_type3();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"entry_type3".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Entry_type3) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
