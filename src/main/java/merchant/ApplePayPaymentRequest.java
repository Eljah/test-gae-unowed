...
/**
 *  ApplePayPaymentRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ApplePayPaymentRequest implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Recurrent
     */
    protected boolean localRecurrent;

    /**
     * field for RecurrentInitialize
     */
    protected boolean localRecurrentInitialize;
    ...
    public boolean getRecurrent() {
        return localRecurrent;
    }

    /**
     * Auto generated setter method
     * @param param Recurrent
     */
    public void setRecurrent(boolean param) {
        this.localRecurrent = param;
    }
     ...
     * @return boolean
     */
    public boolean getRecurrentInitialize() {
        return localRecurrentInitialize;
    }

    /**
     * Auto generated setter method
     * @param param RecurrentInitialize
     */
    public void setRecurrentInitialize(boolean param) {
        this.localRecurrentInitialize = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":applePayPaymentRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "applePayPaymentRequest", xmlWriter);
            }
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "recurrent", xmlWriter);

        if (false) {
            throw new org.apache.axis2.databinding.ADBException(
                "recurrent cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localRecurrent));
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "recurrentInitialize", xmlWriter);

        if (false) {
            throw new org.apache.axis2.databinding.ADBException(
                "recurrentInitialize cannot be null!!");
        } else {
            xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localRecurrentInitialize));
        }
    ...
    public static class Factory {
        ...
        public static ApplePayPaymentRequest parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "recurrent").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "recurrentInitialize").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "recurrentInitialize" +
                            "  cannot be null");
                    }
