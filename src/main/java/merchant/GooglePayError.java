...
/**
 *  GooglePayError bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GooglePayError implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":googlePayError", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "googlePayError", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GooglePayError parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GooglePayError object = new GooglePayError();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"googlePayError".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GooglePayError) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
