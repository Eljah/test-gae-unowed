...
public class ItemAttributes implements org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Array!
     */
    protected ItemAttribute[] localAttributes;
     ...
     * @return ru.paymentgate.engine.webservices.merchant.ItemAttribute[]
     */
     ...
     * @param param ru.paymentgate.engine.webservices.merchant.ItemAttribute
     */
    public void addAttributes(
        ItemAttribute param) {
        if (localAttributes == null) {
            localAttributes = new ItemAttribute[] {
        ...
        list.add(param);
        this.localAttributes = (ItemAttribute[]) list.toArray(new ItemAttribute[list.size()]);
    }
        ...
        public static ItemAttributes parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"itemAttributes".equals(type)) {
                            ...
                            return (ItemAttributes) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    list1.add(ItemAttribute.Factory.parse(
                            reader));
                    ...
                    object.setAttributes((ItemAttribute[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            ItemAttribute.class,
                            list1));
