...
/**
 *  DeliveryInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DeliveryInfo implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected String localDeliveryType;
     ...
     */
    public void setDeliveryType(String param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":deliveryInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "deliveryInfo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DeliveryInfo parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            DeliveryInfo object = new DeliveryInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"deliveryInfo".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DeliveryInfo) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "deliveryType").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "deliveryType" +
                            "  cannot be null");
                    }

                    String content = reader.getElementText();

                    object.setDeliveryType(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
