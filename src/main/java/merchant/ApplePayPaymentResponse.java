...
/**
 *  ApplePayPaymentResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ApplePayPaymentResponse implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":applePayPaymentResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "applePayPaymentResponse", xmlWriter);
            }
        }
