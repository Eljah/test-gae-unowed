...
/**
 *  SamsungError bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SamsungError implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":samsungError", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "samsungError", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SamsungError parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SamsungError object = new SamsungError();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"samsungError".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SamsungError) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
