...
public class SamsungPayPaymentResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Data
     */
    protected SamsungData localData;
     ...
     * field for Error
     */
    protected SamsungError localError;
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.SamsungData
     */
    public SamsungData getData() {
        return localData;
    }
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.SamsungError
     */
    public SamsungError getError() {
        return localError;
    }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"samsungPayPaymentResponse".equals(type)) {
                            ...
                            return (SamsungPayPaymentResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(SamsungData.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "error").equals(
                            reader.getName())) {
                    object.setError(SamsungError.Factory.parse(
                            reader));
