...
/**
 *  RecurrentPaymentResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RecurrentPaymentResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = recurrentPaymentResponse
     ...
     * field for Data
     */
    protected merchant.RecurrentPaymentData localData;
     ...
     * field for Error
     */
    protected merchant.RecurrentPaymentError localError;
    ...
    /**
     * Auto generated getter method
     * @return merchant.RecurrentPaymentData
     */
    public merchant.RecurrentPaymentData getData() {
        return localData;
    }
     ...
     */
    public void setData(
        merchant.RecurrentPaymentData param) {
    ...
    /**
     * Auto generated getter method
     * @return merchant.RecurrentPaymentError
     */
    public merchant.RecurrentPaymentError getError() {
        return localError;
    }
    ...
    public void setError(
        merchant.RecurrentPaymentError param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":recurrentPaymentResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "recurrentPaymentResponse", xmlWriter);
            }
        }
        ...
        if (localOrderStatusTracker) {
            ...
            localOrderStatus.serialize(new javax.xml.namespace.QName("",
    ...
    public static class Factory {
         ...
         */
        public static RecurrentPaymentResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RecurrentPaymentResponse object = new RecurrentPaymentResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"recurrentPaymentResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RecurrentPaymentResponse) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(merchant.RecurrentPaymentData.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "error").equals(
                            reader.getName())) {
                    object.setError(merchant.RecurrentPaymentError.Factory.parse(
                            reader));
