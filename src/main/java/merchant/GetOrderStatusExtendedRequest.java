/**
 * GetOrderStatusExtendedRequest.java
 *
...
/**
 *  GetOrderStatusExtendedRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetOrderStatusExtendedRequest extends merchant.OrderStatusRequest
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getOrderStatusExtendedRequest
     ...
     */
    protected boolean localMerchantOrderNumberTracker = false;

    public boolean isMerchantOrderNumberSpecified() {
        return localMerchantOrderNumberTracker;
    }
    ...
    public void setMerchantOrderNumber(java.lang.String param) {
        localMerchantOrderNumberTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":getOrderStatusExtendedRequest",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "getOrderStatusExtendedRequest", xmlWriter);
        }
        ...
        if (localMerchantOrderNumberTracker) {
            namespace = "";
            writeStartElement(null, namespace, "merchantOrderNumber", xmlWriter);

            if (localMerchantOrderNumber == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "merchantOrderNumber cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localMerchantOrderNumber);
            }
    ...
    public static class Factory {
         ...
         */
        public static GetOrderStatusExtendedRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetOrderStatusExtendedRequest object = new GetOrderStatusExtendedRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getOrderStatusExtendedRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetOrderStatusExtendedRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "merchantOrderNumber").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "merchantOrderNumber" +
                            "  cannot be null");
                    }
