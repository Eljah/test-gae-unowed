...
/**
 *  GooglePayResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GooglePayResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Data
     */
    protected merchant.GooglePayData localData;
     ...
     * field for Error
     */
    protected merchant.GooglePayError localError;
    ...
    /**
     * Auto generated getter method
     * @return merchant.GooglePayData
     */
    public merchant.GooglePayData getData() {
        return localData;
    }
    ...
    /**
     * Auto generated getter method
     * @return merchant.GooglePayError
     */
    public merchant.GooglePayError getError() {
        return localError;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":googlePayResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "googlePayResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GooglePayResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GooglePayResponse object = new GooglePayResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"googlePayResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GooglePayResponse) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(merchant.GooglePayData.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "error").equals(
                            reader.getName())) {
                    object.setError(merchant.GooglePayError.Factory.parse(
                            reader));
