...
public class GooglePayResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Data
     */
    protected GooglePayData localData;
     ...
     * field for Error
     */
    protected GooglePayError localError;
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.GooglePayData
     */
    public GooglePayData getData() {
        return localData;
    }
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.GooglePayError
     */
    public GooglePayError getError() {
        return localError;
    }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"googlePayResponse".equals(type)) {
                            ...
                            return (GooglePayResponse) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(GooglePayData.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "error").equals(
                            reader.getName())) {
                    object.setError(GooglePayError.Factory.parse(
                            reader));
