...
/**
 *  OrderResult bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class OrderResult extends merchant.AbstractResponse
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":orderResult", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "orderResult", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static OrderResult parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            OrderResult object = new OrderResult();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"orderResult".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OrderResult) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
