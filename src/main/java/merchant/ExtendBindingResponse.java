...
/**
 *  ExtendBindingResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExtendBindingResponse extends merchant.AbstractServiceResponse
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = extendBindingResponse
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":extendBindingResponse", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "extendBindingResponse", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static ExtendBindingResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExtendBindingResponse object = new ExtendBindingResponse();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"extendBindingResponse".equals(type)) {
                            ...
                            return (ExtendBindingResponse) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
