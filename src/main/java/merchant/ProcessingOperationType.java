...
/**
 *  ProcessingOperationType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ProcessingOperationType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final ProcessingOperationType PRE_AUTH = new ProcessingOperationType(_PRE_AUTH,
            true);
    public static final ProcessingOperationType COMPLETION = new ProcessingOperationType(_COMPLETION,
            true);
    public static final ProcessingOperationType REVERSAL_FOR_PRE_AUTH = new ProcessingOperationType(_REVERSAL_FOR_PRE_AUTH,
            true);
    public static final ProcessingOperationType REVERSAL_FOR_COMPLETION = new ProcessingOperationType(_REVERSAL_FOR_COMPLETION,
            true);
    public static final ProcessingOperationType REFUND = new ProcessingOperationType(_REFUND,
            true);
    public static final ProcessingOperationType PURCHASE = new ProcessingOperationType(_PURCHASE,
            true);
    public static final ProcessingOperationType REVERSAL_FOR_PURCHASE = new ProcessingOperationType(_REVERSAL_FOR_PURCHASE,
            true);
    public static final ProcessingOperationType COMMUNICATION_REVERSAL = new ProcessingOperationType(_COMMUNICATION_REVERSAL,
            true);
    public static final ProcessingOperationType REVERSAL_FOR_REFUND = new ProcessingOperationType(_REVERSAL_FOR_REFUND,
            true);
    ...
    protected ProcessingOperationType(java.lang.String value,
        ...
        if (isRegisterValue) {
            _table_.put(localProcessingOperationType, this);
        }
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":processingOperationType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "processingOperationType", xmlWriter);
            }
        }

        if (localProcessingOperationType == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "processingOperationType cannot be null !!");
        } else {
            xmlWriter.writeCharacters(localProcessingOperationType);
        }
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement() || reader.hasText()) {
                        ...
                        if ("true".equals(nillableValue) ||
                            ...
                            throw new org.apache.axis2.databinding.ADBException(
                                "The element: " + "processingOperationType" +
                                "  cannot be null");
                        }
                        ...
                        if (content.indexOf(":") > 0) {
                            ...
                            object = ProcessingOperationType.Factory.fromString(content,
                                    namespaceuri);
                        } else {
