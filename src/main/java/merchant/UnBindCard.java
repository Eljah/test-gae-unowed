...
/**
 *  UnBindCard bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UnBindCard implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":unBindCard", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "unBindCard", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static UnBindCard parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            UnBindCard object = new UnBindCard();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"unBindCard".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (UnBindCard) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
