...
/**
 *  VerifyEnrollment bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class VerifyEnrollment implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":verifyEnrollment", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "verifyEnrollment", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static VerifyEnrollment parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            VerifyEnrollment object = new VerifyEnrollment();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"verifyEnrollment".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (VerifyEnrollment) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
