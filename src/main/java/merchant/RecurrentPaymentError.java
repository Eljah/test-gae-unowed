...
/**
 *  RecurrentPaymentError bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RecurrentPaymentError implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = recurrentPaymentError
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":recurrentPaymentError", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "recurrentPaymentError", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RecurrentPaymentError parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RecurrentPaymentError object = new RecurrentPaymentError();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"recurrentPaymentError".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RecurrentPaymentError) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
