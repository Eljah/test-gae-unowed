...
/**
 *  CardBindingInfo bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CardBindingInfo implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = cardBindingInfo
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":cardBindingInfo", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "cardBindingInfo", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CardBindingInfo parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CardBindingInfo object = new CardBindingInfo();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"cardBindingInfo".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CardBindingInfo) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
