...
public class CustomerDetails implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected merchant.DeliveryInfo localDeliveryInfo;
    ...
    /**
     * Auto generated getter method
     * @return merchant.DeliveryInfo
     */
    public merchant.DeliveryInfo getDeliveryInfo() {
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerDetails".equals(type)) {
                            ...
                            return (CustomerDetails) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "deliveryInfo").equals(
                            reader.getName())) {
                    object.setDeliveryInfo(merchant.DeliveryInfo.Factory.parse(
                            reader));
