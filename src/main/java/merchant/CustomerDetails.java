...
public class CustomerDetails implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * Auto generated getter method
     * @return ru.paymentgate.engine.webservices.merchant.DeliveryInfo
     */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localDeliveryInfoTracker) {
            if (localDeliveryInfo == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "deliveryInfo cannot be null!!");
            }

            localDeliveryInfo.serialize(new javax.xml.namespace.QName("",
    ...
    public static class Factory {
         ...
         */
        public static CustomerDetails parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerDetails".equals(type)) {
                            ...
                            return (CustomerDetails) ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "contact" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "deliveryInfo").equals(
                            reader.getName())) {
                    object.setDeliveryInfo(DeliveryInfo.Factory.parse(
                            reader));
