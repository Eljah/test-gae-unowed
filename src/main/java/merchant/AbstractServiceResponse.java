...
/**
 *  AbstractServiceResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public abstract class AbstractServiceResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = abstractServiceResponse
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":abstractServiceResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "abstractServiceResponse", xmlWriter);
            }
        }
