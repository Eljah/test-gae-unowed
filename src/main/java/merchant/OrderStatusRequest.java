...
/**
 *  OrderStatusRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class OrderStatusRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":orderStatusRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "orderStatusRequest", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static OrderStatusRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OrderStatusRequest object = new OrderStatusRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"orderStatusRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OrderStatusRequest) merchant.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
